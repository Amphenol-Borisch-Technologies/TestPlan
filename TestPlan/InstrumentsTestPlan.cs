namespace ABT.Test.TestPlans.Diagnostics.TestPlan.InstrumentsTestPlan {
    ...
    internal class SwitchingUnits {
        internal static String MSMU_34980A() {
            if (Data.testSequence.IsOperation) Debug.Assert(Assertions.TestOperation(NamespaceTrunk: "InstrumentsTestPlan", ProductionTest: "true", Description: "Manufacturer\'s self-tests + ABT tests of TestPlanDefinition\'s InstrumentsTestPlan.", TestGroups: "SwitchingUnits|PowerSupplies|DigitalMultiMeters|Oscilloscopes|WaveformGenerators"));
            Debug.Assert(Assertions.TestGroup(Classname: "SwitchingUnits", Description: "Keysight 34980As.", CancelNotPassed: "false", Independent: "true", Methods: "MSMU_34980A"));
            Debug.Assert(Assertions.MethodCustom(Name: "MSMU_34980A", Description: "Keysight 34980A Multifunction Switch/Measurement Units.", CancelNotPassed: "false"));
    ...
    internal class PowerSupplies {
        internal static String PS_E3634A() {
            Debug.Assert(Assertions.TestGroup(Classname: "PowerSupplies", Description: "Keysight E3634As & E3649As.", CancelNotPassed: "false", Independent: "true", Methods: "PS_E3634A|PS_E3649A"));
            Debug.Assert(Assertions.MethodCustom(Name: "PS_E3634A", Description: "Keysight E3634A Power Supplies.", CancelNotPassed: "false"));
        ...
        internal static String PS_E3649A() {
            Debug.Assert(Assertions.MethodCustom(Name: "PS_E3649A", Description: "Keysight E3649A Power Supplies.", CancelNotPassed: "false"));
    ...
    internal class DigitalMultiMeters {
        internal static String MM_34401A() {
            Debug.Assert(Assertions.TestGroup(Classname: "DigitalMultiMeters", Description: "Keysight 34401As.", CancelNotPassed: "false", Independent: "true", Methods: "MM_34401A"));
            Debug.Assert(Assertions.MethodCustom(Name: "MM_34401A", Description: "Keysight 34401A Digital Multi-Meters.", CancelNotPassed: "false"));
    ...
    internal class Oscilloscopes {
        internal static String MSO_3014() {
            Debug.Assert(Assertions.TestGroup(Classname: "Oscilloscopes", Description: "Tektronix MSO-3014s.", CancelNotPassed: "false", Independent: "true", Methods: "MSO_3014"));
            Debug.Assert(Assertions.MethodCustom(Name: "MSO_3014", Description: "Tektronix MSO-3014 Mixed-Signal Oscilloscopes.", CancelNotPassed: "false"));
    ...
    internal class WaveformGenerators {
        internal static String WG_33120A() {
            Debug.Assert(Assertions.TestGroup(Classname: "WaveformGenerators", Description: "Keysight 33120As.", CancelNotPassed: "false", Independent: "true", Methods: "WG_33120A"));
            Debug.Assert(Assertions.MethodCustom(Name: "WG_33120A", Description: "Keysight 33120A 15MHz Function/Arbitrary Waveform Generators.", CancelNotPassed: "false"));
