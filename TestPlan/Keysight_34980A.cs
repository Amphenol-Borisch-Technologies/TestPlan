namespace ABT.Test.TestPlans.Diagnostics.TestPlan.Keysight_34980A {
    ...
    internal class Keysight_34921As {
        internal static String Keysight_34921A() {
            if (Data.testSequence.IsOperation) Debug.Assert(TestIndices.TestOperation.Assert(NamespaceTrunk: "Keysight_34980A", ProductionTest: "false", Description: "Keysight 34980A Module Tests.", TestGroups: "Keysight_34921As|Keysight_34932As|Keysight_34938As|Keysight_34952As"));
    ...
    internal class Keysight_34932As {
        ...
        internal static String Keysight_34932A() {
            ...
            Debug.Assert(((MethodCustom)TestIndices.Method).Assert(Name: "Keysight_34932A", Description: "Keysight 34032A Dual 4x16 Armature Matrix.", CancelNotPassed: "false"));
    ...
    internal class Keysight_34938As {
        ...
        internal static String Keysight_34938A() {
            ...
            Debug.Assert(((MethodCustom)TestIndices.Method).Assert(Name: "Keysight_34938A", Description: "Keysight 34938A 20-Channel 5 Amp Form A General Purpose Switch Module.", CancelNotPassed: "false"));
    ...
    internal class Keysight_34939As {
        ...
        internal static String Keysight_34939A() {
            Debug.Assert(TestIndices.TestGroup.Assert(Classname: "Keysight_34930As", Description: "Keysight 34939A Modules.", CancelNotPassed: "false", Independent: "true", Methods: "Keysight_34939A"));
            Debug.Assert(((MethodCustom)TestIndices.Method).Assert(Name: "Keysight_34939A", Description: "Keysight 34939A 64-Channel 1 Amp Form A General Purpose Switch Module.", CancelNotPassed: "false"));
    ...
    internal class Keysight_34952As {
        ...
        internal static String Keysight_34952A() {
            ...
            Debug.Assert(((MethodCustom)TestIndices.Method).Assert(Name: "Keysight_34952A", Description: "Keysight 34952A Multifunction Module.", CancelNotPassed: "false"));
