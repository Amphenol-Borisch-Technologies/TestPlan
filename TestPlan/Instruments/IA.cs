...
namespace ABT.Test.UUT.Instruments {
    /// <summary>
    /// IA correlates TestExecutive.GlobalConfigurationFile's canonical SCPI_VISA_InstrumentElement IDs to meaningful TestExecutor Customer UUT specific names, or aliases.
    /// <para>
